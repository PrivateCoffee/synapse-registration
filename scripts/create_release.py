...
PRE_RELEASE_COMMANDS = (
    ("-m", "ruff", "check", "src/synapse_registration", "scripts"),
    ("-m", "ruff", "format", "--check", "src/synapse_registration", "scripts"),
    ("-m", "djlint", "src/synapse_registration", "--check"),
    (
        "-m",
        "django",
        "test",
        "synapse_registration.registration.tests",
        "--settings=synapse_registration.synapse_registration.settings",
    ),
)
